...
def execute_complete_pipeline(epochs=35, batch_size=32, K=4):
    """
...
if __name__ == "__main__":
    # Execute with 35 training epochs by default
    execute_complete_pipeline(epochs=35, batch_size=32, K=4)
